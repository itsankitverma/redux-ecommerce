        ...
        <div>
            <div className="flex flex-col gap-10 py-5 items-center justify-center px-5">
                ...
                {selector.map((val, id) => {
                    ...
                    return (
                        <div key={id} className="border-2 md:border-0 border-gray-500 p-4 py-10 flex flex-col md:flex-row space-y-5 gap-20 items-start justify-center">
                            ...
                            <div className='w-full flex flex-col gap-2'>
                                ...
                                <div className='flex md:flex-row flex-col gap-5'>
                                    ...
                                    <button onClick={() => dispatch(removeFromCart(val.id))} className='px-5 py-4 border-2 border-gray-300 rounded-sm bg-yellow-600 text-white'>Remove From Cart</button>
                                </div>
